                    ...
                    <div className="card-body">
                        <form className="row">
                            ...
                            <div className="col-md-6">
                                <div className="form-group">
                                    <label>Street: </label>
                                    <input  placeholder="Stree number etc" name="street" className="form-control"
                                           />
                                ...
                                <div className="form-group">
                                    <label>House #: </label>
                                    <input placeholder="House number" name="houseNumber" className="form-control" type="number"
                                           />
